		...
		<div class="row-fluid">
			...
			<div class="span9">
				...
				<div class="page-header">
					<h1><g:message code="Búsqueda de Historial Médico" args="[entityName]" /></h1>
				</div>
				...
				<g:form action="show">
					...
					<br/>
					<g:submitButton name="showDetails" value="Mostrar Historial Médico" class="btn btn-primary btn-info"/>
				</g:form>
